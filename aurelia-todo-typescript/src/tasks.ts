...
export class Tasks
{
    ...
    public taskItems : Array<TodoItem>;
    public filteredItems : Array<TodoItem>;
    public model : TodoItem;
    public rules : ValidationRules;

    private store : TodoRepo;
    
    constructor(private bindingEngine, private validationController)
    {
    ...
    observeTodoItem(todoItem : TodoItem)
    {
    ...
    onIsDoneChanged(todoItem : TodoItem)
    {
    ...
    filterTasks()
    {
        ...
        let filteredTasks = this.taskItems.filter(function (todoItem : TodoItem)
        {
            let showItem = true;
            if (filterByText)
            {
                let todoText : string = todoItem.description.toLowerCase();
    ...
    deleteCompletedTasks()
    {
        ...
        let completedTasks = this.taskItems.filter(
            function(task)
            {
                return task.isDone;
            });
